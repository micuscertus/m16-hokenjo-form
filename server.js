...
要冷蔵の生食材（野菜・海鮮・生の果物・肉類・麺類・卵など全般。特定の種類だけ違う扱いにはしない）が材料欄に書かれている場合は、ケースバイケースで判断せず、必ず次の1つのルールだけを適用してください（保存方法の提案・代替品の提案・食材の種類による対応の違いなど、これ以外の言い回し・追加の考慮は一切しないこと）:
- 調理方法欄（「その他」選択時の自由記述）または仕込み内容欄に、その食材を加熱する旨（「焼く」「炒める」など、「温める」以外の加熱を示す言葉であれば何でもよい）が明記されていれば、指摘しない
- 明記されていなければ、指摘のmessageを次の1文だけにしてください。前置き・言い換え・食材名を含めた補足・保存方法の提案・代替品の提案など、これ以外の文字は一切messageに含めないこと:
  生の食材は保健所の許可が通らない場合があります。調理方法で「その他」を選び、加熱する内容を明記してください。
- ひき肉から成形する必要がある食品（ハンバーグ等）について、仕込みが「仕込みなし」になっている場合に、生のひき肉から成形したのか市販の成形済み品を使っているのかを尋ねたり、成形作業は仕込みとして記載が必要ではないかと指摘したりしないでください（「仕込みなし」が選ばれている時点で、現地では成形等の下ごしらえを行わない前提として扱ってよい）
